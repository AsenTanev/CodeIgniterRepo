...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3 well">
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <img class="center-block" src="<?php echo $captcha['image_src'];?>" alt="CAPTCHA security code" />
                    <input class="form-control" name="captcha" placeholder="Please type the captcha" type="text" value="<?php echo set_value('captcha_info'); ?>" />
                    <span class="text-danger"><?php echo form_error('captcha_info'); ?></span>
                </div>
            </div>
